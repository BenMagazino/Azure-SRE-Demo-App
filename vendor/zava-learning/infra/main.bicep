...
@description('Preserve an existing PagerDuty action group without resubmitting its webhook.')
param pagerDutyConfigured string = 'false'
...
module aca 'modules/aca.bicep' = {
  ...
  params: {
    ...
    secretUriDbPassword: keyvault.outputs.dbCredentialUri
    secretUriSecretLane: keyvault.outputs.secretUriSecretLane
    secretUriPoolPassword: keyvault.outputs.poolCredentialUri
  }
}
...
output AZURE_SRE_AGENT_IDENTITY_ID string = identity.outputs.agentIdentityId
